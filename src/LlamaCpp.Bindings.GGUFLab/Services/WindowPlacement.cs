...
/// <summary>
/// On-disk persistence + apply/capture helpers for the GGUFLab
...
/// self-contained class because GGUFLab has no other persistent
/// settings yet.
/// </summary>
public static class WindowPlacementStore
{
    ...
    /// <summary>Where the placement file lives. <c>%AppData%/GGUFLab/window-placement.json</c> on Windows; <c>~/.config/GGUFLab/...</c> on Linux.</summary>
